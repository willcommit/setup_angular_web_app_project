...
- How to enforce a decoupled architecture (key to scalability). MVVM pattern. REST API. Interfacing. Abstract implementation. Dependency Injection. Multi repo - hard decoupling
- API services
